<template>
  <main>
<div class="w-full text-gray-700 bg-blue-700 dark-mode:text-gray-200 dark-mode:bg-gray-800 h-16">
  <div class="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
    ...
    <div :class="{'flex-col': open, 'hidden': !open}" class="flex md:hidden">
       <a class="px-4 py-2 mt-2 text-sm font-semibold" href="#">Cart</a>
       <a class="px-4 py-2 mt-2 text-sm font-semibold" href="#">Wishlist</a>
       <a class="px-4 py-2 mt-2 text-sm font-semibold" href="#">Settings</a>
       <a class="px-4 py-2 mt-2 text-sm font-semibold" href="#">Logout</a>
    </div>
     <div class="relative ml-56 w-5/12">
          <input title="Search Bar" aria-label="search bar" role="search" class="pr-8 pl-4 py-2 rounded-md cursor-pointer focus:border-blue-600 focus:cursor-text w-full placeholder-transparent focus:placeholder-blue-500" type="text" placeholder="Search" />
