...
<nav
    ...
    class=" tp flex fixed w-full items-center justify-between flex-wrap px-6 h-12 bg-blue-700  z-10 top-0 animated">
      ...
      <div class="flex items-center text-white">
        <nuxt-link to="/mobile/Login" class="m-2 hover:bg-blue-300 p-1 rounded-lg text-sm">Sign In</nuxt-link>
...
<div class="pt-24 bg-gray-200 max-w-full m-auto">
  <nuxt/>
</div>
<nav
:class="{ 'scrolled': !view.atTopOfPage }"
	...
	<section id="bottom-navigation" class="block fixed inset-x-0 bottom-0 z-10 bg-white shadow">
		<div id="tabs" class="flex justify-between">
			...
			<a href="#" class="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center p-1">
				...
				<span class="tab tab-whishlist block text-xs">Wishlist</span>
			</a>
			<a href=# class="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center p-1">
				<svg width="25" height="25" viewBox="0 0 42 42" class="inline-block">
			    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
