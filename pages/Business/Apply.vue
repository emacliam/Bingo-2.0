<template>
<main>
    <div class="text-center bg-teal-50 pt-16 pb-4">
        <div class="text-teal-600 text-center m-auto w-2/4 p-1 mb-1">
        <h1 class="font-bold">Apply to Sell on ProductFinder Marketplace</h1>
        <h2 class="italic text-sm">Becoming a ProductFinder Seller is easy</h2>
        <h2 class="italic text-sm">Simply complete the form and and we'll be in touch within -10 business days </h2>
        <h2 class="italic text-sm">We use the email and phoneNumbers you are going to provide to get in touch with you</h2>
        </div>
