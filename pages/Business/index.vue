<template>
  <main class="">
    <div class="h-64 max-w-full bg-purple-500 mx-8">
      <div class="m-auto max-w-md pt-16">
        <h1 class="text-white mb-6 text-lg font-semibold">
          JOIN THE BEST MARKETPLACE IN ZIMBABWE
        </h1>
        <p></p>
        <nuxt-link
          to="/Business/Apply"
          class="text-sm p-2 w-48 border border-white rounded hover:text-blue-500 text-white hover:bg-white
              "
          >Apply to sell</nuxt-link
        >
        <nuxt-link
          to="/Business/Login"
          class="text-sm p-2 w-48 border border-white rounded hover:text-blue-500 text-white hover:bg-white"
    ...
    <div class=" max-w-full mx-8 mt-2">
      <h2 class="text-blue-700 font-semibold text-lg mb-6 text-center">
        Get the tools you need to increase sales and grow your business online
      </h2>
      <div class="flex justify-between">
        <div class="rounded-lg h-56 w-64 bg-blue-500"></div>
        <div class="rounded-lg h-56 w-64 bg-blue-500"></div>
        <div class="rounded-lg h-56 w-64 bg-blue-500"></div>
        <div class="rounded-lg h-56 w-64 bg-blue-500"></div>
      </div>
    ...
    <div>
      <!-- component -->
      <div class="bg-blue-600 mt-8 p-4">
        ...
        <div class="flex">
          <div class="w-1/3 text-center px-6">
            ...
            >
              ...
              >
                <h2 class="font-bold text-sm">Application</h2>
                <p class="text-xs text-gray-600">
                  Apply now and tell us about your business and products.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="w-1/3 text-center px-6">
            ...
            >
              ...
              <div
                class="w-2/3 bg-gray-200 h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step"
              >
                <h2 class="font-bold text-sm">Approval</h2>
                <p class="text-xs text-gray-600">
                  We'll review your application and get in touch within 5-10
                  business days.
                </p>
              </div>
            </div>
          ...
          <div class="w-1/3 text-center px-6">
            ...
            >
              ...
              <div
                class="w-2/3 bg-gray-200 h-24 flex flex-col items-center justify-center px-1 rounded-r-lg body-step"
              >
                <h2 class="font-bold text-sm">Sells and Make Profit</h2>
                <p class="text-xs text-gray-600">
                  Get your products live and start selling.Boost your online
                  sales via promotions, analyse your performance using reports
                  and so much more.
                </p>
              </div>
            </div>
