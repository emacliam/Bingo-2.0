<template>
  <div class="fixed bottom-0 right-0 flex flex-col items-end ml-6 w-full">
    ...
    >
      ...
      <!-- admin profile -->
      <div
        class="flex justify-between items-center text-white p-2 bg-blue-700 border shadow-lg mr-5 w-full"
      >
        <div class="flex items-center">
          ...
          />
          <h2 class="font-semibold tracking-wider">Ngonidzashe@Bingo</h2>
        </div>
        <div class="flex items-center justify-center">
          <small class="mr-1">online</small>
          <div class="rounded-full w-2 h-2 bg-green-400"></div>
        </div>
      </div>
      <!-- chats -->
      <div class="flex flex-col bg-gray-200 px-2 chat-services overflow-auto">
        <div
          class="chat bg-white text-gray-700 p-2 self-start my-2 rounded-md shadow mr-3"
        >
          apa ada yang bisa saya bantu ?
        </div>
        <div
          class="message bg-blue-700 text-white p-2 self-end my-2 rounded-md shadow ml-3"
        >
        ...
        <div
          class="message bg-white text-gray-700 p-2 self-start my-2 rounded-md shadow mr-3"
        >
      ...
      <div class="relative bg-white">
        ...
        />
        <button
          class="absolute right-0 bottom-0 text-blue-600 bg-white  hover:text-blue-500 m-1 px-3 py-1 w-auto transistion-color duration-100 focus:outline-none"
        >
          Send
        </button>
      </div>
